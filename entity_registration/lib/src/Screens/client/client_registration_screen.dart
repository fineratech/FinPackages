...
import 'package:entity_registration/src/Screens/client/client_registration_view_model.dart';
...
class ClientRegistrationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ClientRegistrationViewModel(
      ...
      builder: (context, _) {
        return Consumer<ClientRegistrationViewModel>(
                ...
                child: Column(
                  children: [
                    CustomTextField(
                      ...
                      label: 'Client Name',
                      controller: viewModel.clientNameController,
