...
class ProjectFunctionProvider implements FunctionDefinitionsProvider {
  ...
  List<Map<String, dynamic>> getFunctionDefinitions() {
    switch (projectType) {
      ...
      case ProjectType.law:
        return _getLawFunctionDefinitions();
    }
  }
  ...
  Future<Map<String, dynamic>> executeFunction(
    ...
    switch (projectType) {
      ...
      case ProjectType.law:
        return await _executeLawFunction(functionName, args);
    }
  }
  ...
  /// Law function definitions
  List<Map<String, dynamic>> _getLawFunctionDefinitions() {
    return [
      {
        "name": "get_all_services",
        "description": "Get all Law services available in the system",
        "parameters": {
          "type": "object",
          "properties": {},
          "required": [],
      ...
      },
      {
        "name": "find_resource_availability_in_a_month",
        "description":
            "Get the availability of a lawyer or firm for re-scheduling appointments in a specific month",
        "parameters": {
          "type": "object",
          "properties": {
            "resource_id": {
              "type": "string",
              "description":
                  "The unique identifier of the resource (e.g., lawyer id) to check availability for. Prefer professional ID or resource id over user ID."
            },
            "month": {
              "type": "string",
              "description":
      ...
      },
      {
        ...
        "description":
            "Get all available lawyers/firms professionals in the system. Use this as the FIRST STEP when a user wants to book/schedule a NEW appointment. This will help the user choose which therapist they want to see. Keywords: 'book appointment', 'schedule appointment', 'make appointment', 'see a therapist', 'I need law advice'.",
        "parameters": {
          "type": "object",
          "properties": {},
          "required": [],
      ...
      {
        "name": "get_services_by_lawyer",
        "description":
            "Get all services offered by a specific lawyer. Use this after user selects a therapist to show what services they can book.",
        "parameters": {
          "type": "object",
          "properties": {
            "lawyer_id": {
              "type": "string",
              "description":
                  "The unique identifier of the lawyer professional, professional ID obtained from get_all_lawyers function, not the name"
            }
          },
          "required": ["lawyer_id"],
        }
      },
      {
        "name": "schedule_new_appointment",
        "description":
            "Use this to book a NEW appointment (not for rescheduling existing ones). This function handles the complete flow including payment processing and appointment creation. IMPORTANT STEPS TO FOLLOW:\n1. Get all lawyers using get_all_lawyers\n2. Ask user to select a lawyer\n3. Get services for selected lawyer using get_services_by_lawyer\n4. Ask user to select a service\n5. Check availability using find_resource_availability_in_a_month\n6. Ask user to select a date and time slot\n7. ASK USER: 'How would you like to pay? (card/cash)' - You MUST ask this question before calling this function\n8. Only after getting payment method preference, call this function with all the required information.",
        "parameters": {
          "type": "object",
          "properties": {
            "client_id": {
              "type": "string",
              "description":
                  "The unique identifier of the client booking the appointment"
            },
            "lawyer_id": {
              "type": "string",
              "description": "The unique identifier of the lawyer professional"
            },
            "service_id": {
              "type": "string",
              "description": "The unique identifier of the service being booked"
  ...
  /// Execute law-specific functions
  Future<Map<String, dynamic>> _executeLawFunction(
    String functionName,
    Map<String, dynamic> args,
  ) async {
    try {
      switch (functionName) {
        case 'get_all_services':
          final services = await apiFunctionsService
              .getAllAvailableServicesByCategory('legal');
          if (services != null) {
            final servicesData =
                services.map((service) => service.toMap()).toList();
            return {
              ...
              'services': servicesData,
              'count': services.length,
              'message': 'Law services retrieved successfully'
            };
          }
          return {
            'success': false,
        ...
        case 'get_all_lawyers':
          final professionalIds =
              await apiFunctionsService.findResourceEfficient(
            "lawyer", // resourceType
            "legal", // useCaseType
          );
          ...
          final professionals = await Future.wait(futures);
          final lawyersData = professionals
              .where((professional) => professional != null)
              .toList();
        ...
        case 'get_services_by_lawyer':
          final lawyerId = args['lawyer_id'];
          final allServices = await apiFunctionsService
              .getAllAvailableServicesByCategory('legal');

          if (allServices != null && allServices.isNotEmpty) {
            final lawyerServices = allServices
                .where((service) =>
                    service.resourceId == lawyerId ||
                    service.providerId == lawyerId)
                .toList();

            final servicesData = lawyerServices
                .map((service) => {
                      'service_id': service.serviceId,
                      'name': service.name,
                      'type': service.type,
            ...
            return {
              ...
              'lawyer_id': lawyerId,
              'message':
                  'Services for lawyer retrieved successfully. Found ${servicesData.length} service(s).'
            };
          }
          return {
            'success': false,
            'services': [],
            'count': 0,
            'message': 'No services found for this lawyer'
          };
        ...
        case 'schedule_new_appointment':
          ...
          // Step 1: Create shopping cart
          final cartId =
              await apiFunctionsService.getIDForNewShoppingCart(clientId);
          ...
          final status = isCardPayment ? "PaymentsMade" : "Received";
